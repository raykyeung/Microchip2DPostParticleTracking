...
name = B2Knextname('A','_1','.txt') % start from one.
fclose(fopen(name,'w')); % make new file with that name.
name = B2Knextname('A','_1','.txt')
fclose(fopen(name,'w')); % make new file with that name.
name = B2Knextname('A','_1','.txt')
fclose(fopen(name,'w')); % make new file with that name.
%% Start Value
...
name = B2Knextname('A','_100','.txt') % start from one hundred.
fclose(fopen(name,'w'));
name = B2Knextname('A','_100','.txt')
fclose(fopen(name,'w'));
name = B2Knextname('A','_0','.txt') % start from zero.
fclose(fopen(name,'w'));
name = B2Knextname('A','_0','.txt')
fclose(fopen(name,'w'));
%% Leading Zeros
...
B2Knextname(name,'(1)','.txt',false) % default: output = name only.
B2Knextname(name,'(1)','.txt',true) % output includes same path as input.
