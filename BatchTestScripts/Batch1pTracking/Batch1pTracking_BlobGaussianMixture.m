...
for vidNumIdx = loopStart:loopEnd
    ...
    try
        [L_start,R_end,tFrames,nFrames,...
            ...
            myFigures] = B2KVideoSummary30(vidObj,myFigures,flagDebug,flagRunWithDisplay,addedFrames);
    ...
    try
        [I, CS, WR, CR, NR, x_pos_caption, y_pos_caption,myFigures,...
            ...
            Hlines_highest,Hlines_highest_num] = B2KCoordinateSystem30(vidObj,L_start_orig, HLcorrectionidx,EXP_W_channel,CS_string,myFigures,flagDebug,flagRunWithDisplay);
    ...
    try
        [myFigures,time_ms,position_x_CS,velocity_x_CS,acceleration_x_CS,position_y_CS,velocity_y_CS,acceleration_y_CS,meanThroughput_x_CS] = B2KParticleTracking30(vidNumIdx,vidObj,myFigures,onePTrackOutputFolderPath,L_start,R_end,tFrames,nFrames,I,CS,x_pos_caption,y_pos_caption,EXP_actualframerate,flagDebug,flagRunWithDisplay);
