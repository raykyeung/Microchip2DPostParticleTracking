function [settingAddedFrames,flagInternalDrive,flagBatch,flagDebug,flagRunWithDisplay,flagSaveLocDefault,flagTimeFunction,flagTimeSaveFunctionData,flagCalcParameters,flagDataPathOverride,flagDriveOverride,flagSingleVidOverride] = B2KFlagsBGM(addedFrames,drivePriority,processingMode,runMode,displayMode,saveLocation,timeFunction,timeSaveFunctionData,calcParameters,dataPathOverride,driveOverride,singleVidOverride)
%% B2KFlagBGM - [Function]
%
