...
%% B2KVideoSummary30.m - [Function] Batch single p-Chip tracking
%
...
%
% Example usage:
%   [L_start, R_end, tFrames, nFrames, flagPres, flagStuck, flagNone, flagCorrupt, myFigures] = ...
%         B2KVideoSummary(vidObj, myFigures, false, true, 25);
