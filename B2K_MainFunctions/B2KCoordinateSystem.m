function [I_average, CS, WR, CR, NR, x_pos_caption, y_pos_caption,myFigures,varargout] = B2KCoordinateSystem(vidObj,L_start_orig, HLcorrectionidx,EXP_W_channel,CS_string,myFigures,flagDebug,flagRunWithDisplay)
%% B2KCoordinateSystem.m - [Function]
%
