function [myFigures,time_ms,position_x_CS,velocity_x_CS,acceleration_x_CS,position_y_CS,velocity_y_CS,acceleration_y_CS,meanThroughput_x_CS] = B2KParticleTrackingBGM(i,vidObj,myFigures,onePTrackOutputFolderPath,L_start,R_end,tFrames,nFrames,I,CS,x_pos_caption,y_pos_caption,EXP_actualframerate,flagDebug,flagRunWithDisplay)
%% B2KParticleTrackingBGM.m - [Function] Batch single p-Chip tracking
%
